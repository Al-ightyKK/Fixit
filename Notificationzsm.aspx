<%@ Page Title="" Language="C#" MasterPageFile="~/fixitmasterpage.master" AutoEventWireup="true" CodeFile="Notificationzsm.aspx.cs" Inherits="Notificationzsm" %>
...
<br />
<asp:Button ID="Button1" CssClass="button" runat="server" OnClick="Btncontact"  Text="Contact Us" />
    <br />
   ...
   </div></td><td align="right" ><div style="  margin-right:0px; text-align:right; width:26%;">  
...
<div>
       ...
       <asp:GridView ID="notific" HeaderStyle-BackColor="#0d9dbc"
        ...
        RowStyle-Font-Names="calibri" RowStyle-HorizontalAlign="Center" ShowHeaderWhenEmpty="true"
            ...
            <Columns>   
            <asp:BoundField DataField="DIVISION" ItemStyle-Font-Size="Medium" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Left" HeaderText="Division" ItemStyle-Width="100px"  HeaderStyle-Width="100px" />
         <asp:BoundField DataField="NOTIFICATION" ItemStyle-Font-Size="Medium" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Left" HeaderText="Notifications"  ItemStyle-Width="500px"  HeaderStyle-Width="500px" /> 
  <asp:BoundField DataField="Time" ItemStyle-Font-Size="Small" ItemStyle-HorizontalAlign="center" HeaderText="Time"  ItemStyle-Width="200px"  HeaderStyle-Width="200px" /> 
                              </Columns>           
                  </asp:GridView><br /></div>
